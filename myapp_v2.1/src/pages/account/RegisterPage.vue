<template>
  <MyForm ref="form" @submit="onSubmit">
    <q-input v-model="user.name" label="Name" :rules="[v => required(v, 'Name')]" class="q-pt-md">
      <template v-slot:before>
        <q-icon name="person" class="on-left" />
      </template>
    </q-input>

    <q-input v-model="user.submitData.email" label="Email" :rules="[v => required(v, 'Email'), v => email(v)]" class="q-pt-md">
      <template v-slot:before>
        <q-icon name="mail" class="on-left" />
      </template>
    </q-input>

    <q-input v-model="user.submitData.password" label="Password" :rules="[v => required(v, 'Password')]" class="q-pt-md"
